https://agendafisica.wordpress.com/2010/12/01/grace-typesetting-for-titles-legends-tick-marks/
...
\cv\C				# Special symbols, example: o umlaut
\cd\C				# Special symbols, example: a umlaut
...
xmgrace -nxy           # to plot different rows as function of 1st row (==x)
x -nxy simulation.ti
...
xmgracenxy.sh PhononDispersion_4.13

xmgrace -block file -bxy 1:4   # plot 4th column vs 1st column
xmgrace -block file -bxy 1:2 -bxy 1:3  # plot 2 curves
