...
Updated : 22Jan15 *N* Marks New *C* Corrected/Changed
...
mv !?main # recall previous command containing the string main
mv !?main?$ # recall just last parameter of command containing the string main *C*
!?client # recall most recent cmd containing string 'client'
vi !?client?$  # recall just last parameter of cmd containing 'client'
ls (x*~x[3-5])    # list files x* except x3 to x5
...
ls -l **/index.(php|js|css)~(*libs*|*junk*) #
