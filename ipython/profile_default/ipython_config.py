...
# set this hide imported modules to interpreter like function.np and function.sys
c.IPCompleter.limit_to__all__ = True

# IPython can use the deep_reload module which reloads changes in
# modules recursively (it replaces the reload() function, so you dont
...
# autoreload / Reloading submodules in Ipython
c.InteractiveShellApp.extensions = ['autoreload']
c.InteractiveShellApp.exec_lines = ['%autoreload 2']

# cd to path without typing cd  (SEEMS NOT TO WORK)
c.InteractiveShell.implicit_cd = True

# TAB being case insensitive (I dont want that -> False)
c.Completer.case_insensitive = False
...
c.Completer.pprint = True


# execute code when you start ipython
c.InteractiveShellApp.exec_lines = [
    ...
    'xmode context',# xmode: Valid modes: Plain, Context and Verbose
    '%rehashx',
    'plt.ion()'
    ]
...
#c.InteractiveShellApp.pylab = False

## Port tcsh aliases to ipython ... this does not work well for ls
#import os, string
#a = os.popen("tcsh -c 'alias' | grep -v '^cd' | grep -v '^mcd'").readlines()
#b = [tuple(line.strip().split("\t")) for line in a]
#b = b + [
#		('xxxxx', 'xxxxxxx')]
#print "-------------------- a -------------------"
#print a
#print "-------------------- b -------------------"
#print b
#c.AliasManager.user_aliases = [x for x in b if len(x) == 2]

c.AliasManager.user_aliases = [
		  ('ls', '/usr/local/opt/coreutils/libexec/gnubin/ls --color=auto -F -H -v --show-control-chars'),
		  ('vi', 'vi'),
		  ('x', 'xmgrace')
		  ]


# found this line, dont know for what it is
...
# variable IPYTHONDIR.
# c.TerminalIPythonApp.ipython_dir = u'/Users/glensk/.ipython'
