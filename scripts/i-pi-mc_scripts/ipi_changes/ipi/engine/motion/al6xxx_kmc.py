...
def write_vacancy_pos_header(cellvec0,step,nvac):
    filename = "vacancy_pos.xyz"
...
def write_vacancy_pos(sites,svac):
    filename = "vacancy_pos.xyz"
...
class AlKMC(Motion):
    ...
    def step(self, step=None):
        ...
        for i in xrange(len(levents)):
            ...
            line_new = 'Event %3s %3s %20s >B> %20s >F> %20s' % (i, levents[i][-1], ecurr, ets, levents[i][2])
            print line_new
