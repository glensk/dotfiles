...
def save_and_add_to_ecache(ecache_file,new_ecache_entries):
    #print('---adding to echae ---- needs to stay as it is')
    #print(new_ecache_entries)
    ff = open(ecache_file, "a+b")
    pickle.dump(new_ecache_entries, ff)
    ff.close()
    #print('---adding to echae done----')
    #print()
    return
