...
def _run_lammps_at_strain(lmp, e1=0,e2=0,e3=0,e4=0,e5=0,e6=0,lattice_const=0):
...
def _collect_strain_energies(lmp, strain_definition, strain_range,lattice_const):
    energies = []
