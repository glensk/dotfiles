...
file=$scripts/runner_scripts/ase_fileformat_for_runner.py
[ ! -e "$file" ] && echo giulios runner file $file does not exist && exit

conda_ase_io_folder1=`ls -1d $HOME/miniconda3/lib/python3.*/site-packages/ase/io/`
echo "conda_ase_io_folder1:$conda_ase_io_folder1:"
...
echo
echo
echo will work in following folder:
...
echo successfuly copied runner.py.
