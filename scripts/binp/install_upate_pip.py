...
def todo(args):
    ...
    packages = [ 'numpy', 'pandas', 'phonopy', 'ase' , 'lmfit', 'intel-numpy', 'tqdm', 'jupyter', 'jupyter_contrib_nbextensions', 'plotly', 'virtualenv', 'aiida-core' ] #, 'aiida-quantumespresso==3.0.0a5' ]
