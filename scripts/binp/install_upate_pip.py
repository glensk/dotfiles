...
def todo(args):
    ...
    packages = [ 'numpy', 'pandas', 'phonopy', 'cython', 'pyspglib', 'ase' , 'lmfit', 'intel-numpy', 'tqdm', 'jupyter', 'jupyter_contrib_nbextensions', 'plotly', 'virtualenv', 'aiida-core', 'pathlib', 'iterm2' ] #, 'aiida-quantumespresso==3.0.0a5' ]
