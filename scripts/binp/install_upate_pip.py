...
def todo(args):
    ...
    packages = [ 'numpy', 'pandas', 'phonopy', 'cython', 'pyspglib', 'ase' , 'lmfit', 'intel-numpy', 'tqdm', 'jupyter', 'jupyter_contrib_nbextensions', 'plotly', 'virtualenv', 'pathlib', 'iterm2', 'yfinance', 'quandl', 'yahoo_finance','termcolor', 'BeautifulSoup4', 'html5lib' ] # 'aiida-core', #, 'aiida-quantumespresso==3.0.0a5' ]
