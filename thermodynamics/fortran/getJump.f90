program getJump
     ...
     !mach radius groesser noettig fuer bcc, so haben wir keine "leeren raeume"
     !im Kristallgitter welche nicht beruecksichtigt werden
     ! radius = (3*(radius**2))**0.5   == faktor 1.7
     ! im simple cubic system ist a/2 / radius  == 0.5 / 0.62 = 0.8
     radius = radius*1.3
     !radius = 2*radius/3
