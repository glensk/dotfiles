...
options=$*; . $path/utilities/functions.include; checkOptions "-h -help -helpin -helpout -P -s -f -e -o"
...
nF=`ls -1 F* | wc -l`
nG=`ls -1 Gform_* 2> /dev/null | wc -l`
nM=`ls -1 M* 2> /dev/null | wc -l`
